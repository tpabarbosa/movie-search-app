...
var IndexPage = /** @class */ (function (_super) {
    ...
    function IndexPage(props, movies) {
        ...
        _this.moviesBox = MoviesHorizontal.create(movies);
        _this.moviesPopUp = MoviePopup.create(props);
        return _this;
    }
    var _a;
    _a = IndexPage;
    IndexPage.create = function (props) { return __awaiter(void 0, void 0, void 0, function () {
        var movies;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, IndexPage.loadMovies()];
                case 1:
                    movies = _b.sent();
                    return [2 /*return*/, new IndexPage(props, movies)];
            }
        });
    }); };
    IndexPage.loadMovies = function () { return __awaiter(void 0, void 0, void 0, function () {
        var moviesData, movies;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    moviesData = LocalStorageManager.getSuggestions();
                    if (!(!moviesData || isDateOlderThan(moviesData.date, oneDay))) return [3 /*break*/, 2];
                    return [4 /*yield*/, MovieService.getSuggestions()];
                case 1:
                    movies = _b.sent();
                    return [3 /*break*/, 3];
                case 2:
