...
var MarkAsFavorite = /** @class */ (function (_super) {
    __extends(MarkAsFavorite, _super);
    function MarkAsFavorite(appProps, opt) {
        var _this = this;
        var _a;
        ...
        _this.id = '';
        _this.load = function () {
            var html = "\n            <div id=\"mark-as-favorite-".concat(_this.id, "\" class=\"mark-as-favorite\">\n                \n            </div>\n            \n        ");
            return html;
        };
        _this.onLoad = function () {
            _this.container = document.getElementById("mark-as-favorite-".concat(_this.id));
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, MovieService.markAsFavorite(userId, this.session_id, this.movieId, !this.favorite)];
                        case 1:
                            resp = _b.sent();
    ...
    MarkAsFavorite.prototype.startCountdown = function () {
        var _this = this;
        setTimeout(function () {
            _this.apiMessage.classList.add('hidden');
            _this.apiMessage.innerText = '';
